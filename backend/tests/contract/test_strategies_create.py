...
class TestStrategiesCreateContract:
    ...
    def test_create_strategy_success_contract(
        ...
        response: Response = client.post(
            "/api/v1/strategies", json=valid_strategy_create_data
        )
        ...
        assert actual_params == expected_params, (
            f"Parameters mismatch: expected {expected_params}, " f"got {actual_params}"
        )
    ...
    def test_create_strategy_minimal_data_contract(self, client: TestClient) -> None:
        """
        ...
        # Act
        response: Response = client.post("/api/v1/strategies", json=minimal_data)
    ...
    def test_create_strategy_invalid_category_contract(
        ...
        # Act
        response: Response = client.post("/api/v1/strategies", json=invalid_data)
    ...
    def test_create_strategy_missing_required_fields_contract(
        ...
        """
        # Test missing name
        missing_name_data = {"category": "predatory", "target_symbols": ["NIFTY"]}
        ...
        missing_category_data = {"name": "Test Strategy", "target_symbols": ["NIFTY"]}
        ...
        missing_symbols_data = {"name": "Test Strategy", "category": "predatory"}
    ...
    def test_create_strategy_invalid_json_contract(self, client: TestClient) -> None:
        """
    ...
    def test_create_strategy_duplicate_name_contract(
        ...
        assert (
            response2.status_code in acceptable_codes
        ), f"Duplicate name should return {acceptable_codes}, got {response2.status_code}"

    def test_create_strategy_all_categories_contract(self, client: TestClient) -> None:
        """

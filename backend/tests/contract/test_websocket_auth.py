        ...
        with pytest.raises((ConnectionError, ConnectionRefusedError, OSError)):
            ...
            try:
                ...
                assert "timestamp" in response, (
                    "auth_response must contain timestamp"
                )
                
                assert "data" in response, (
                    "auth_response must contain data"
                )
        ...
        with pytest.raises((ConnectionError, ConnectionRefusedError, OSError)):
            ...
            try:
                ...
                try:
                    ...
                    assert response["type"] in ["auth_response", "error"], (
                    ...
                    try:
                        ...
                        if i < 5:
                            ...
                            if response["data"]["status"] == "failed":
                                assert "connection limit" in response["data"]["error"].lower()
                            break
